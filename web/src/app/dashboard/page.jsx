        ...
        <div className="fixed lg:relative inset-y-0 left-0 z-50 bg-white w-64 flex-shrink-0 border-r border-gray-200 flex flex-col">
          <div className="flex-1 overflow-y-auto">
            <nav className="p-4 space-y-2">
              ...
              <div>
                ...
                {expandedMenus["work-orders"] && (
                  <div className="ml-6 mt-2 space-y-1 bg-green-50 p-2 rounded-lg">
                    ...
                    <div className="px-3 py-2 text-gray-600 text-sm cursor-pointer hover:text-green-700 hover:bg-green-100 rounded transition-colors">
                      Pending Payments
                    </div>
                  </div>
                )}
              ...
              <div className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:bg-green-50 hover:text-green-700 rounded-lg cursor-pointer transition-colors">
