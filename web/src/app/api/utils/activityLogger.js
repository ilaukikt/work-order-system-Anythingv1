...
export function createWorkOrderActivity(workOrderId, workOrderData, userName = 'System User') {
  return {
...
export function updateWorkOrderActivity(workOrderId, originalData, updatedData, userName = 'System User') {
  const changes = [];
  
  // Track specific field changes
  const fieldsToTrack = [
    'wo_number', 'vendor_name', 'site_name', 'total_amount', 
    'net_amount', 'status', 'vendor_contact', 'work_description'
  ];
...
export function deleteWorkOrderActivity(workOrderId, workOrderData, userName = 'System User') {
  return {
...
export function statusChangeActivity(workOrderId, woNumber, fromStatus, toStatus, userName = 'System User') {
  return {
