...
export default function VendorsPage() {
  ...
  const getVendorTypeBadge = (type) => {
    ...
    const typeConfig = config[type] || { bg: "bg-gray-100", text: "text-gray-800" };
  ...
  const getStatusBadge = (status) => {
    ...
    const statusConfig = config[status] || { bg: "bg-gray-100", text: "text-gray-800" };
        ...
        <div className="flex-1 overflow-y-auto">
          <nav className="p-4 space-y-2">
            ...
            <div
              ...
              className="flex items-center gap-3 px-3 py-2 text-[#5D667E] dark:text-[#B0B0B0] hover:bg-[#DFF3EA] dark:hover:bg-[#0C8657]/20 active:bg-[#D1F0DD] dark:active:bg-[#0C8657]/30 hover:text-[#0C8657] dark:hover:text-[#22C55E] rounded-lg cursor-pointer transition-colors"
            >
              <Building2 size={16} className="text-[#0C8657] dark:text-[#22C55E]" />
            ...
            <div>
              ...
              >
                <FileText size={16} className="text-[#0C8657] dark:text-[#22C55E]" />
                {sidebarOpen && (
                  <>
                    ...
                    {expandedMenus["work-orders"] ? (
                      <ChevronUp size={14} className="text-[#5D667E] dark:text-[#B0B0B0]" />
                    ) : (
                      <ChevronDown size={14} className="text-[#5D667E] dark:text-[#B0B0B0]" />
                    )}
                  </>
                )}
              </div>
            ...
            <div
              ...
              className="flex items-center gap-3 px-3 py-2 text-[#5D667E] dark:text-[#B0B0B0] hover:bg-[#DFF3EA] dark:hover:bg-[#0C8657]/20 active:bg-[#D1F0DD] dark:active:bg-[#0C8657]/30 hover:text-[#0C8657] dark:hover:text-[#22C55E] rounded-lg cursor-pointer transition-colors"
            >
              <Activity size={16} className="text-[#0C8657] dark:text-[#22C55E]" />
              {sidebarOpen && <span className="font-medium flex-1">Activity Log</span>}
            </div>
            ...
            <div className="flex items-center gap-3 px-3 py-2 text-[#5D667E] dark:text-[#B0B0B0] hover:bg-[#DFF3EA] dark:hover:bg-[#0C8657]/20 active:bg-[#D1F0DD] dark:active:bg-[#0C8657]/30 hover:text-[#0C8657] dark:hover:text-[#22C55E] rounded-lg cursor-pointer transition-colors">
              <Settings size={16} className="text-[#0C8657] dark:text-[#22C55E]" />
              {sidebarOpen && <span className="font-medium flex-1">Settings</span>}
            </div>
          </nav>
        </div>
      </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  <Search size={20} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#9DA5BC] dark:text-[#888888]" />
                  <input
                    type="text"
          ...
          <div className="bg-white dark:bg-[#1E1E1E] rounded-lg border border-[#E4E8EE] dark:border-[#333333] overflow-hidden">
            {isLoading ? (
              <div className="flex items-center justify-center py-12">
                <Loader2 size={32} className="text-[#0C8657] dark:text-[#22C55E] animate-spin" />
              </div>
            ) : error ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  <AlertCircle size={32} className="text-[#E95D5D] dark:text-[#EF4444] mx-auto mb-2" />
                  <p className="text-[#5D667E] dark:text-[#B0B0B0]">{error.message}</p>
                </div>
              </div>
            ) : vendors.length === 0 ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  <Users size={32} className="text-[#9DA5BC] dark:text-[#888888] mx-auto mb-2" />
                  <p className="text-[#5D667E] dark:text-[#B0B0B0]">No vendors found</p>
                </div>
              </div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#F7FAFC] dark:bg-[#262626] border-b border-[#E4E8EE] dark:border-[#333333]">
                    <tr>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Vendor Name</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Type</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Contact Person</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Contact Number</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Default Retention %</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Status</th>
                      <th className="text-left py-3 px-4 font-medium text-[#5D667E] dark:text-[#B0B0B0]">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {vendors.map((vendor) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">{getVendorTypeBadge(vendor.vendor_type)}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#1E1E1E] rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <h4 className="text-md font-semibold text-[#1F2739] dark:text-[#FFFFFF] mb-4">Basic Information</h4>
              ...
              <div>
                <h4 className="text-md font-semibold text-[#1F2739] dark:text-[#FFFFFF] mb-4">Address & Tax Details</h4>
              ...
              <div>
                <h4 className="text-md font-semibold text-[#1F2739] dark:text-[#FFFFFF] mb-4">Banking Details</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#1F2739] dark:text-[#FFFFFF] mb-1">
                      Bank Name
              ...
              <div>
                <h4 className="text-md font-semibold text-[#1F2739] dark:text-[#FFFFFF] mb-4">Default Settings</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[#1F2739] dark:text-[#FFFFFF] mb-1">
                      Default Retention %
